...
const TESTIMONIALS = [
  ...
  [`"Working with V J Desai & Co., Chartered Accountants, has greatly improved our business over the last three years. Their expertise in Income Tax, GST, and TDS filings has made managing our financial obligations much easier. Their attention to detail and focus on client satisfaction is commendable, and their complete service approach ensures thoroughness. The knowledgeable team keeps up with changing regulations, helping us remain compliant. Thanks to them, we meet deadlines consistently and experience less stress during filing seasons."`, 'VS', '#2471A3', '#fff', 'Vatsal Shingala', 'Google Review · a year ago'],
