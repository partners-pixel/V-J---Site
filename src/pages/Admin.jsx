...
import ChecklistManager from '../admin/ChecklistManager.jsx';
...
export default function Admin() {
  ...
  const Section = { dashboard: Dashboard, pages: Pages, blog: BlogManager, checklists: ChecklistManager, enquiries: Enquiries, reviews: Reviews }[section];
